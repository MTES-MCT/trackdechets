// Taken from https://gist.github.com/ammarshah/f5c2624d767f91a7cbdc4e54db8dd0bf
const PUBLIC_EMAIL_PROVIDER_DOMAINS = [
  "0-mail.com",
  "007addict.com",
  "020.co.uk",
  "027168.com",
...
// not listed in public list
const EXTRA_EMAIL_PROVIDER_DOMAINS = ["bbox.fr", "nordnet.fr"];

export const EMAIL_PROVIDER_DOMAINS = [
  ...PUBLIC_EMAIL_PROVIDER_DOMAINS,
  EXTRA_EMAIL_PROVIDER_DOMAINS
];
