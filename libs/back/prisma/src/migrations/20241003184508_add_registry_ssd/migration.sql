...
-- CreateEnum
CREATE TYPE "RegistryUnit" AS ENUM ('M3', 'T');
...
-- CreateTable
CREATE TABLE "RegistryImportSiret" (
    "importId" TEXT NOT NULL,
    "siret" TEXT NOT NULL,

    CONSTRAINT "RegistryImportSiret_pkey" PRIMARY KEY ("importId","siret")
);
...
CREATE TABLE "RegistrySsd" (
    ...
    "destinationFullDestinationAddress" TEXT,
...
-- AddForeignKey
ALTER TABLE "RegistryImportSiret" ADD CONSTRAINT "RegistryImportSiret_importId_fkey" FOREIGN KEY ("importId") REFERENCES "RegistryImport"("id") ON DELETE CASCADE ON UPDATE CASCADE;
