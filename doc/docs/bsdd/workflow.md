...
L'ensemble des champs du BSD numérique est décrit dans la [référence de l'API](../api-reference/bsdd/objects.md#form). Au cours de son cycle de vie, un BSD numérique peut passer par différents états décrits [ici](../api-reference/bsdd/objects.md#formstatus).
...
| `updateForm`               | `DRAFT -> DRAFT` <br />                                                                                                         | [FormInput](../api-reference/bsdd/inputObjects#forminput)                                           | <div><ul><li>émetteur</li><li>destinataire</li><li>transporteur</li><li>négociant</li><li>éco-organisme</li></ul></div>                                                                 |
