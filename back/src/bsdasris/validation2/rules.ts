...
export const bsdasriEditionRules: BsdasriEditionRules = {
  ...
  destinationReceptionWasteVolume: {
    ...
    path: ["destination", "reception", "volume"]
  },
  ...
  ecoOrganismeName: {
    ...
    sealed: { from: "EMISSION", when: sealedFromEmission },
...
function sealedFromEmission(bsdasri: ZodBsdasri) {
