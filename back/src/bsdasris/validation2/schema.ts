...
import { DASRI_WASTE_CODES_VALUES } from "@td/constants";
import { CompanyRole, siretSchema } from "../../common/validation/zod/schema";
import { isEcoOrganismeRefinement } from "../../common/validation/zod/refinement";
import { BsdasriValidationContext } from "./types";
import { runTransformers } from "./transformers";
import { weightSchema } from "../../common/validation/weight";
import { v20250201, WeightUnits } from "../../common/validation";
import {
  checkCompanies,
  checkWeights,
  checkRequiredFields,
  validateBsdasriTransporterPlates,
  checkOperationMode
  // checkOperationMode,
...
export const rawBsdasriSchema = z.object({
  ...
  status: z.nativeEnum(BsdasriStatus).default(BsdasriStatus.INITIAL),
  ...
  // emitterWasteVolume: z.number().nullish(), COMPUTED
  ...
  destinationOperationCode: z.string().nullish(),
...
const refinedBsdasriSchema = rawBsdasriSchema
  ...
  .superRefine(validateBsdasriTransporterPlates)
