...
export interface Exists {
  ...
  securityCode: (where?: SecurityCodeWhereInput) => Promise<boolean>;
...
export interface Prisma {
  ...
  securityCode: (
    where: SecurityCodeWhereUniqueInput
  ) => SecurityCodeNullablePromise;
  securityCodes: (args?: {
    where?: SecurityCodeWhereInput;
    orderBy?: SecurityCodeOrderByInput;
    skip?: Int;
    after?: String;
    before?: String;
    first?: Int;
    last?: Int;
  }) => FragmentableArray<SecurityCode>;
  securityCodesConnection: (args?: {
    where?: SecurityCodeWhereInput;
    orderBy?: SecurityCodeOrderByInput;
    skip?: Int;
    after?: String;
  ...
  createSecurityCode: (data: SecurityCodeCreateInput) => SecurityCodePromise;
  updateSecurityCode: (args: {
    data: SecurityCodeUpdateInput;
    where: SecurityCodeWhereUniqueInput;
  }) => SecurityCodePromise;
  updateManySecurityCodes: (args: {
    data: SecurityCodeUpdateManyMutationInput;
    where?: SecurityCodeWhereInput;
  }) => BatchPayloadPromise;
  upsertSecurityCode: (args: {
    where: SecurityCodeWhereUniqueInput;
    create: SecurityCodeCreateInput;
    update: SecurityCodeUpdateInput;
  }) => SecurityCodePromise;
  deleteSecurityCode: (
    where: SecurityCodeWhereUniqueInput
  ) => SecurityCodePromise;
  deleteManySecurityCodes: (
    where?: SecurityCodeWhereInput
  ) => BatchPayloadPromise;
...
export interface Subscription {
  ...
  securityCode: (
    where?: SecurityCodeSubscriptionWhereInput
  ) => SecurityCodeSubscriptionPayloadSubscription;
  user: (
...
export type SecurityCodeOrderByInput =
  | "siret_ASC"
  | "siret_DESC"
  | "code_ASC"
  | "code_DESC";
...
export interface SecurityCodeUpdateManyMutationInput {
  code?: Maybe<Int>;
}
...
export interface SecurityCodeCreateInput {
  siret?: Maybe<ID_Input>;
  company: CompanyCreateOneInput;
  code: Int;
}
...
export interface SecurityCodeWhereInput {
  siret?: Maybe<ID_Input>;
  siret_not?: Maybe<ID_Input>;
  siret_in?: Maybe<ID_Input[] | ID_Input>;
  siret_not_in?: Maybe<ID_Input[] | ID_Input>;
  siret_lt?: Maybe<ID_Input>;
  siret_lte?: Maybe<ID_Input>;
  siret_gt?: Maybe<ID_Input>;
  siret_gte?: Maybe<ID_Input>;
  siret_contains?: Maybe<ID_Input>;
  siret_not_contains?: Maybe<ID_Input>;
  siret_starts_with?: Maybe<ID_Input>;
  siret_not_starts_with?: Maybe<ID_Input>;
  siret_ends_with?: Maybe<ID_Input>;
  siret_not_ends_with?: Maybe<ID_Input>;
  ...
  code_gt?: Maybe<Int>;
  code_gte?: Maybe<Int>;
  AND?: Maybe<SecurityCodeWhereInput[] | SecurityCodeWhereInput>;
  OR?: Maybe<SecurityCodeWhereInput[] | SecurityCodeWhereInput>;
  NOT?: Maybe<SecurityCodeWhereInput[] | SecurityCodeWhereInput>;
}
...
export interface SecurityCodeSubscriptionWhereInput {
  mutation_in?: Maybe<MutationType[] | MutationType>;
  updatedFields_contains?: Maybe<String>;
  updatedFields_contains_every?: Maybe<String[] | String>;
  updatedFields_contains_some?: Maybe<String[] | String>;
  node?: Maybe<SecurityCodeWhereInput>;
  AND?: Maybe<
    SecurityCodeSubscriptionWhereInput[] | SecurityCodeSubscriptionWhereInput
  >;
  OR?: Maybe<
    SecurityCodeSubscriptionWhereInput[] | SecurityCodeSubscriptionWhereInput
  >;
...
export type SecurityCodeWhereUniqueInput = AtLeastOne<{
  siret: Maybe<ID_Input>;
}>;
...
export interface SecurityCodeUpdateInput {
  company?: Maybe<CompanyUpdateOneRequiredInput>;
  code?: Maybe<Int>;
}
...
export interface AggregateSecurityCode {
  count: Int;
}

export interface AggregateSecurityCodePromise
  extends Promise<AggregateSecurityCode>,
    Fragmentable {
  count: () => Promise<Int>;
}

export interface AggregateSecurityCodeSubscription
  extends Promise<AsyncIterator<AggregateSecurityCode>>,
    Fragmentable {
  count: () => Promise<AsyncIterator<Int>>;
}
...
export interface SecurityCodeConnection {
  pageInfo: PageInfo;
  edges: SecurityCodeEdge[];
}

export interface SecurityCodeConnectionPromise
  extends Promise<SecurityCodeConnection>,
    Fragmentable {
  pageInfo: <T = PageInfoPromise>() => T;
  edges: <T = FragmentableArray<SecurityCodeEdge>>() => T;
  aggregate: <T = AggregateSecurityCodePromise>() => T;
}

export interface SecurityCodeConnectionSubscription
  extends Promise<AsyncIterator<SecurityCodeConnection>>,
    Fragmentable {
  pageInfo: <T = PageInfoSubscription>() => T;
  edges: <T = Promise<AsyncIterator<SecurityCodeEdgeSubscription>>>() => T;
  aggregate: <T = AggregateSecurityCodeSubscription>() => T;
}
...
export interface SecurityCodePromise
  extends Promise<SecurityCode>,
    Fragmentable {
  siret: () => Promise<ID_Output>;
  company: <T = CompanyPromise>() => T;
  code: () => Promise<Int>;
}

export interface SecurityCodeSubscription
  extends Promise<AsyncIterator<SecurityCode>>,
    Fragmentable {
  siret: () => Promise<AsyncIterator<ID_Output>>;
  company: <T = CompanySubscription>() => T;
  code: () => Promise<AsyncIterator<Int>>;
}

export interface SecurityCodeNullablePromise
  extends Promise<SecurityCode | null>,
    Fragmentable {
  siret: () => Promise<ID_Output>;
  company: <T = CompanyPromise>() => T;
  code: () => Promise<Int>;
...
export interface SecurityCodeEdge {
  node: SecurityCode;
  cursor: String;
}

export interface SecurityCodeEdgePromise
  extends Promise<SecurityCodeEdge>,
    Fragmentable {
  node: <T = SecurityCodePromise>() => T;
  cursor: () => Promise<String>;
}

export interface SecurityCodeEdgeSubscription
  extends Promise<AsyncIterator<SecurityCodeEdge>>,
    Fragmentable {
  node: <T = SecurityCodeSubscription>() => T;
  cursor: () => Promise<AsyncIterator<String>>;
}
...
export interface SecurityCodePreviousValues {
  siret: ID_Output;
  code: Int;
}

export interface SecurityCodePreviousValuesPromise
  extends Promise<SecurityCodePreviousValues>,
    Fragmentable {
  siret: () => Promise<ID_Output>;
  code: () => Promise<Int>;
}

export interface SecurityCodePreviousValuesSubscription
  extends Promise<AsyncIterator<SecurityCodePreviousValues>>,
    Fragmentable {
  siret: () => Promise<AsyncIterator<ID_Output>>;
  code: () => Promise<AsyncIterator<Int>>;
}

export interface SecurityCodeSubscriptionPayload {
  mutation: MutationType;
  node: SecurityCode;
  updatedFields: String[];
...
export interface SecurityCodeSubscriptionPayloadPromise
  extends Promise<SecurityCodeSubscriptionPayload>,
    Fragmentable {
  mutation: () => Promise<MutationType>;
  node: <T = SecurityCodePromise>() => T;
  updatedFields: () => Promise<String[]>;
  previousValues: <T = SecurityCodePreviousValuesPromise>() => T;
}

export interface SecurityCodeSubscriptionPayloadSubscription
  extends Promise<AsyncIterator<SecurityCodeSubscriptionPayload>>,
    Fragmentable {
  mutation: () => Promise<AsyncIterator<MutationType>>;
  node: <T = SecurityCodeSubscription>() => T;
  updatedFields: () => Promise<AsyncIterator<String[]>>;
  previousValues: <T = SecurityCodePreviousValuesSubscription>() => T;
}
