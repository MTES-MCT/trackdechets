...
export const editionRules: {
  ...
  transporterIsExemptedOfReceipt: "TRANSPORT",
  transporterReceipt: "TRANSPORT",
  transporterDepartment: "TRANSPORT",
  transporterValidityLimit: "TRANSPORT",
