...
export function toBsdElastic(form: FormForElastic): BsdElastic {
  ...
  if(form.readableId === "BSD-20230626-JH2PXE7BB"){
    ...
    console.log("Date de réception (destinationReceptionDate / form.receivedAt): ", form.receivedAt)
    console.log("Date de réalisation de l'opération (destinationOperationDate / form.processedAt):", form?.processedAt)
  }
