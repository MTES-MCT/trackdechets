...
export const createCompanySchema = inputRule()(yup =>
  yup.object({
    companyInput: yup.object({
      siret: yup.string().required("Le SIRET de l'entreprise est obligatoire"),
...
export const createUploadLinkSchema = inputRule()(yup =>
  yup.object({
