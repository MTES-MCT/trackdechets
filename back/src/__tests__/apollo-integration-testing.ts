...
// --------------------------------------------
// Copy-pasted frm https://github.com/zapier/apollo-server-integration-testing
// The lib doesn't support Apollo 3.x yet.
// The code is identical, the problem is just about dependencies: requiring Apollo 2.X
// and similar older librairies.
// There is an (old) ongoing PR to fix that: https://github.com/zapier/apollo-server-integration-testing/pull/20
// As soon as it gets merged, we can remove this code, update `apollo-server-integration-testing` and use it again.
// --------------------------------------------
