...
export const EXHAUSTIVE_EXPORT_COLUMNS = {
  bsdId: { label: "N° de bordereau" },
  createdAt: { label: "Date de création du bordereau", format: formatDate },
  updatedAt: {
    label: "Date de dernière modification du bordereau",
  ...
  traderRecepisseNumber: { label: "Négociant - Récépissé" },
  traderCompanyMail: { label: "Négociant - Contact" },
  intermediary1CompanySiret: { label: "Intermédiaire n°1 - SIRET" },
  intermediary1CompanyName: { label: "Intermédiaire n°1 - Raison sociale" },
  intermediary2CompanySiret: { label: "Intermédiaire n°2 - SIRET" },
  ...
  transporter1UnloadingDate: {
    label: "Transporteur - Date de déchargement",
    format: formatDate
  },
  transporter1CompanySiret: {
    label: "Transporteur - SIRET ou n° de TVA intracommunautaire"
  ...
  transporter2UnloadingDate: {
    label: "Transporteur n°2 - Date de déchargement",
    format: formatDate
  },
  transporter2CompanySiret: {
    label: "Transporteur n°2 - SIRET ou n° de TVA intracommunautaire"
  ...
  transporter3UnloadingDate: {
    label: "Transporteur n°3 - Date de déchargement",
    format: formatDate
  },
  transporter3CompanySiret: {
    label: "Transporteur n°3 - SIRET ou n° de TVA intracommunautaire"
  ...
  transporter4UnloadingDate: {
    label: "Transporteur n°4 - Date de déchargement",
    format: formatDate
  },
  transporter4CompanySiret: {
    label: "Transporteur n°4 - SIRET ou n° de TVA intracommunautaire"
  ...
  transporter5UnloadingDate: {
    label: "Transporteur n°5 - Date de déchargement",
    format: formatDate
  },
  transporter5CompanySiret: {
    label: "Transporteur n°5 - SIRET ou n° de TVA intracommunautaire"
...
export function formatRow(
  ...
  let columns: Record<string, columnInfos>;
  if (exportType === "ALL") {
    columns = EXHAUSTIVE_EXPORT_COLUMNS;
  } else {
