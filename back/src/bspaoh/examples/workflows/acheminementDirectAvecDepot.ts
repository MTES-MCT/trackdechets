import { createBspaoh } from "../steps/createBspaoh";
...
export default {
  title: `Acheminement direct du producteur
 des déchets vers le crématorium avec signature dépôt par le transporteur`,
  companies: [
