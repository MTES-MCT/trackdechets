...
const enum TemplateNames {
  ...
  PROFESIONALS_SECOND_ONBOARDING = "PROFESIONALS_SECOND_ONBOARDING",
  NON_PROFESIONALS_SECOND_ONBOARDING = "NON_PROFESIONALS_SECOND_ONBOARDING"
}
...
const templateIds: templateInterface = {
  ...
  [TemplateNames.PROFESIONALS_SECOND_ONBOARDING]: parseInt(
    process.env.PROFESIONALS_SECOND_ONBOARDING_TEMPLATE_ID,
    10
  ),
  [TemplateNames.NON_PROFESIONALS_SECOND_ONBOARDING]: parseInt(
    process.env.NON_PROFESIONALS_SECOND_ONBOARDING_TEMPLATE_ID,
    10
  )
};
