...
-- AlterEnum
ALTER TABLE "default$default"."Bsff" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "default$default"."Bsff" ALTER COLUMN "status" TYPE VARCHAR(255);
...
ALTER TABLE "default$default"."Bsff" ALTER COLUMN "status" SET DATA TYPE "default$default"."BsffStatus" using "status"::"default$default"."BsffStatus";
ALTER TABLE "default$default"."Bsff" ALTER COLUMN "status" SET DEFAULT E'INITIAL';

-- AlterTable
ALTER TABLE "default$default"."Bsff" ADD COLUMN     "isDraft" BOOLEAN DEFAULT false,
