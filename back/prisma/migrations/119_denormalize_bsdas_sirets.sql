ALTER TABLE "default$default"."Bsda" ADD COLUMN IF NOT EXISTS "intermediariesSiretOrTva" text[] DEFAULT '{}';
...
CREATE INDEX IF NOT EXISTS "_BsdaIntermediariesSiretOrTvaIdx" ON "default$default"."Bsda" USING GIN ("intermediariesSiretOrTva");