...
| `markAsResealed`           | <div><ul><li>`TEMP_STORED -> RESEALED`</li><li>`RESEALED -> RESEALED`</li></ul></div>                                           | [ResealedFormInput](../api-reference/bsdd/inputObjects#resealedforminput)                | Uniquement le site d'entreposage temporaire ou de reconditionnement                                                                                                        |
