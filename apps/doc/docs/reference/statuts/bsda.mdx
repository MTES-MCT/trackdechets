...
E -->|"signBsda (RECEPTION)"| I(RECEIVED)
I -->|"signBsda (OPERATION)"| F(PROCESSED)
I -->|"signBsda (OPERATION) groupement"| G(AWAITING_CHILD)
I -->|"signBsda (OPERATION) refus"| H(REFUSED)
