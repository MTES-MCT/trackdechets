                    ...
                    options={packagingInfos.map((packaging, index) => {
                      ...
                      return {
                        ...
                        onChange: e => {
                          ...
                          const ficheIndex = (watch("ficheInterventions") ?? []).findIndex(
                          ...
                          const currentPackagings =
                            watch(`ficheInterventions.${ficheIndex}.packagings`) ?? [];
                          ...
                          console.log("PACKAGINGS FICHE UPDATED", updatedPackagings);
                        }
                        }
                      };
                    })}
