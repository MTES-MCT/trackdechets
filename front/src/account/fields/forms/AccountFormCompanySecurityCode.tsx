...
export default function AccountFormCompanySecurityCode({
  ...
  const cautionMessage =
    "Attention, vous êtes sur le point de demander un nouveau code de signature qui va vous être attribuer de façon aléatoire, vous veillerez à en informer les personnes en charge de la validation du BSD auprès du transporteur";
