    ...
    <table>
      <tbody>
        <tr>
          ...
          <td data-testid="receiptNumber">{company.brokerReceipt.receiptNumber} </td>
        </tr>
        <tr>
          <td> Limite de validité </td>
          <td data-testid="receiptValidityLimit">{formatDate(company.brokerReceipt.validityLimit)}</td>
        </tr>
        <tr>
          <td> Département</td>
          <td data-testid="receiptDepartment">{company.brokerReceipt.department} </td>
        </tr>
      </tbody>
    </table>
  ) : null;
