                ...
                {isAppendix1Producer ? (
                  ...
                  >
                    ...
                    {bsdd.wasteDetails?.code &&
                      BSDD_SAMPLE_NUMBER_WASTE_CODES.includes(
                        bsdd.wasteDetails.code
                      ) && (
                        <ReviewableField
                          title="Numéro d'achantillon"
                          value={bsdd.wasteDetails?.sampleNumber}
                          name="content.wasteDetails.sampleNumber"
                          defaultValue={initialReview.wasteDetails.sampleNumber}
                        >
                          <Field
                            name="content.wasteDetails.sampleNumber"
                    ...
                    <ReviewableField
                      ...
                      name="content.wasteDetails.quantity"
                      defaultValue={initialReview.wasteDetails.quantity}
                    >
                      <Field
                        name="content.wasteDetails.quantity"
                  ...
                  <>
                    <BsddRequestRevisionCancelationInput
                      ...
                      onChange={value =>
                        setFieldValue("content.isCanceled", value)
                      }
                    />
                    <div
                      style={{
                    ...
                    >
                      ...
                      {isTempStorage ? (
                        <>
                          <ReviewableField
                            ...
                            defaultValue={
                              initialReview.temporaryStorageDetail?.destination
                                ?.cap
                            }
                          >
                            <Field
                      ...
                      >
                        <Field
                          ...
                          label=""
                        />{" "}
                        {Boolean(values.content.wasteDetails.pop)
                          ? "Oui"
                          : "Non"}
                      </ReviewableField>
                      ...
                      {isTempStorage && (
                        <ReviewableField
                          ...
                          defaultValue={
                            initialReview.temporaryStorageDetail
                      ...
                      <ReviewableField
                        ...
                        defaultValue={
                          initialReview.processingOperationDescription
                        }
                      >
                        <Field
                          name="content.processingOperationDescription"
