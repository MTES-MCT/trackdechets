...
const validationSchema = z.object({
  operationCode: z.string().min(1, { message: "Le code opération est requis" }),
...
function SignOperationModal({ bspaoh, onCancel }: SignOperationModalProps) {
  ...
  const {
    ...
    defaultValues: { operationDate: datetimeToDateString(new Date()) },
