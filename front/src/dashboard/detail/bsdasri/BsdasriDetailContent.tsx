  ...
  return (
    <div className={styles.detailColumns}>
      ...
      <div className={styles.detailGrid}>
        ...
        <Dasripackaging packagingInfos={emitter?.emission?.packagingInfos} />
      </div>
      <div className={styles.detailGrid}>
  ...
  return (
    <>
      ...
      <div className={styles.detailGrid}>
        ...
        <Dasripackaging
          packagingInfos={transporter?.transport?.packagingInfos}
        />
        <AcceptationStatusRow
          value={transporter?.transport?.wasteAcceptation?.status}
        />
        <DetailRow
          value={transporter?.transport?.wasteAcceptation?.refusalReason}
          label="Motif de refus"
        />
        <DetailRow
          value={transporter?.transport?.wasteAcceptation?.refusedWeight}
          label="Poids refusée"
          units="kg"
        />
      </div>
  ...
  return (
    <>
      ...
      <div className={styles.detailGrid}>
        ...
        />
        <Dasripackaging
          packagingInfos={destination?.reception?.packagingInfos}
        />
      </div>
      <div className={styles.detailGrid}>
        <DetailRow
          value={getVerboseAcceptationStatus(
            destination?.reception?.wasteAcceptation?.status
          )}
          label="Lot accepté"
        />
        <DetailRow
          value={destination?.reception?.wasteAcceptation?.refusalReason}
          label="Motif de refus"
        />
        <DetailRow
          value={destination?.reception?.wasteAcceptation?.refusedWeight}
          label="Poids refusée"
          units="kg"
        />
        <DetailRow
